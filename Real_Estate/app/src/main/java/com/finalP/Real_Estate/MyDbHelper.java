...
public class MyDbHelper extends SQLiteOpenHelper {
    ...
    public long insertRecord(String image,String name,String mobile,String address,String sqft,String balcony,String bhk,String price,String date,
        ...
        values.put(Constants.C_SQFT,sqft);
        values.put(Constants.C_BALCONY,balcony);
        values.put(Constants.C_BHK,bhk);
    ...
    public void updateRecord(String id,String image,String name,String mobile,String address,String sqft,String balcony,String bhk,String price,String date,
                             String des,String addTime,String updateTime){
        SQLiteDatabase db=this.getWritableDatabase();
        ContentValues values= new ContentValues();
        values.put(Constants.C_IMAGE,image);
        ...
        if (cursor.moveToFirst()){
            do{
                ModelRecord modelRecord=new ModelRecord(
                        ...
                        ""+cursor.getString(cursor.getColumnIndex(Constants.C_SQFT)),
